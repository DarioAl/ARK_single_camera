                ...
                if (type == IMAGES) {
                    ...
                    if (!cap.isOpened()) {
                        ...
                        if (cap.isOpened()) {
                            ...
                            cap.set(CV_CAP_PROP_FRAME_WIDTH, 2064);
                            cap.set(CV_CAP_PROP_FRAME_HEIGHT, 1544);
                        } else {
...
void kilobottracker_singlecamera::LOOPstartstop(int expType)
{
    ...
    if (this->threads && this->threads->isRunning()) {
        ...
        if (this->expType != IDENTIFY) {
            qDebug() << "expType not known stopping experiments";
            emit stopExperiment();
        }
...
void kilobottracker_singlecamera::trackKilobots()
{
    ...
    //imwrite("finalImageB.jpg", this->finalImageB);
